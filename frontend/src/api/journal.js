...
export const deleteJournalCampaign = (id) => api.delete(`/journal/campaigns/${id}/`)
...
export const pauseJournalCampaign = (id) => api.post(`/journal/campaigns/${id}/pause/`)
export const resumeJournalCampaign = (id) => api.post(`/journal/campaigns/${id}/resume/`)
...
export const deleteJournalAttempt = (id) => api.delete(`/journal/attempts/${id}/`)
